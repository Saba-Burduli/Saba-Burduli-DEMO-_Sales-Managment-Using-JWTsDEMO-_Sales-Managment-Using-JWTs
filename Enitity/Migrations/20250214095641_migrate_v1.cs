...
{
    /// <inheritdoc />
    public partial class migrate_v1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderStatusId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderStatusA = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RatingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RatingA = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Ordername = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "OrderStatuses",
                columns: new[] { "OrderStatusId", "OrderStatusA" },
                values: new object[,]
                {
                    { 1, "Pending " },
                    { 2, "Completed " },
            ...
            migrationBuilder.InsertData(
                table: "PersonTypes",
                columns: new[] { "PersontypeId", "PersonTypeDescription", "PersonTypeName" },
                values: new object[,]
                {
                    { 1, "the Customer is always right", "Customer" },
                    { 2, "", "Delivere" },
                    { 3, "", "Employer" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Persons",
                columns: new[] { "PersonId", "Address", "FirstName", "LastName", "PersonTypeId", "Phone" },
                values: new object[] { 1, "Some Address", "Nikoloz", "Varamashvili", 3, "+995 12 34 56" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Email", "PasswordHash", "PersonId", "RegistrationDate", "UserName" },
                values: new object[] { 1, "n.varamashvili@gmail.com", "Admin", 1, new DateTime(2025, 2, 14, 13, 56, 39, 316, DateTimeKind.Local).AddTicks(4938), "Admin" });
